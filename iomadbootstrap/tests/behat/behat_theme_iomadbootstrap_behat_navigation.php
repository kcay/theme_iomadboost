...
class behat_theme_iomadbootstrap_behat_navigation extends behat_navigation {
    ...
    public function menu_item_should_be_active(string $navigationmenuitem): void {
        throw new DriverException(
            'The IOMAD Bootstrap theme does not implement navigation in a way that allows this step to be used.',
        );
    }
    ...
    public function menu_item_should_not_be_active(string $navigationmenuitem): void {
        throw new DriverException(
            'The IOMAD Bootstrap theme does not implement the navigation in a way that allows this step to be used.',
        );
    }
}
